...
(cl:defmethod cl:initialize-instance :after ((m <Imu_data>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Imu_data)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name control-msg:<Imu_data> is deprecated: use control-msg:Imu_data instead.")))

(cl:ensure-generic-function 'acc_x-val :lambda-list '(m))
(cl:defmethod acc_x-val ((m <Imu_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader control-msg:acc_x-val is deprecated.  Use control-msg:acc_x instead.")
  (acc_x m))

(cl:ensure-generic-function 'acc_y-val :lambda-list '(m))
(cl:defmethod acc_y-val ((m <Imu_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader control-msg:acc_y-val is deprecated.  Use control-msg:acc_y instead.")
  (acc_y m))

(cl:ensure-generic-function 'acc_z-val :lambda-list '(m))
(cl:defmethod acc_z-val ((m <Imu_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader control-msg:acc_z-val is deprecated.  Use control-msg:acc_z instead.")
  (acc_z m))

(cl:ensure-generic-function 'gyro_r-val :lambda-list '(m))
(cl:defmethod gyro_r-val ((m <Imu_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader control-msg:gyro_r-val is deprecated.  Use control-msg:gyro_r instead.")
  (gyro_r m))

(cl:ensure-generic-function 'gyro_p-val :lambda-list '(m))
(cl:defmethod gyro_p-val ((m <Imu_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader control-msg:gyro_p-val is deprecated.  Use control-msg:gyro_p instead.")
  (gyro_p m))

(cl:ensure-generic-function 'gyro_y-val :lambda-list '(m))
(cl:defmethod gyro_y-val ((m <Imu_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader control-msg:gyro_y-val is deprecated.  Use control-msg:gyro_y instead.")
  (gyro_y m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Imu_data>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'acc_z))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'gyro_r))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'gyro_p))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Imu_data>) istream)
  "Deserializes a message object of type '<Imu_data>"
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'gyro_r) (roslisp-utils:decode-double-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'gyro_p) (roslisp-utils:decode-double-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Imu_data>)))
  ...
  "a434399257a414fb44320cd9881f0b17")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Imu_data)))
  "Returns md5sum for a message object of type 'Imu_data"
  "a434399257a414fb44320cd9881f0b17")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Imu_data>)))
  ...
  (cl:format cl:nil "float64 acc_x~%float64 acc_y~%float64 acc_z~%float64 gyro_r~%float64 gyro_p~%float64 gyro_y~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Imu_data)))
  "Returns full string definition for message of type 'Imu_data"
  (cl:format cl:nil "float64 acc_x~%float64 acc_y~%float64 acc_z~%float64 gyro_r~%float64 gyro_p~%float64 gyro_y~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Imu_data>))
  ...
  (cl:list 'Imu_data
    ...
    (cl:cons ':gyro_r (gyro_r msg))
    (cl:cons ':gyro_p (gyro_p msg))
