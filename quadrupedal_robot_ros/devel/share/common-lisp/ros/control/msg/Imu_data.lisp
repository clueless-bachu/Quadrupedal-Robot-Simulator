...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Imu_data>)))
  ...
  "4e13d478fc5782f061e903f73ff5e15d")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Imu_data)))
  "Returns md5sum for a message object of type 'Imu_data"
  "4e13d478fc5782f061e903f73ff5e15d")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Imu_data>)))
  ...
  (cl:format cl:nil "Header header~%float64 acc_x~%float64 acc_y~%float64 acc_z~%float64 gyro_r~%float64 gyro_p~%float64 gyro_y~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Imu_data)))
  "Returns full string definition for message of type 'Imu_data"
  (cl:format cl:nil "Header header~%float64 acc_x~%float64 acc_y~%float64 acc_z~%float64 gyro_r~%float64 gyro_p~%float64 gyro_y~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
